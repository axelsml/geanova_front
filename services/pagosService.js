...
class pagosService {
  ...
  ultimoMovimientoBanco(callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
  ...
  getCuentasBancarias(callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
    ...
    call = CancelToken.source();
    return http
      .get("IPagos/cuentas_bancarias", { cancelToken: call.token })
      .then((response) => {
        return callback(response.data);
      })
      .catch((response) => {
  ...
  getTiposFinanciamiento(callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
    ...
    call = CancelToken.source();
    return http
      .get("IPago/tipos_financiamiento", { cancelToken: call.token })
      .then((response) => {
        return callback(response.data);
      })
      .catch((response) => {
  ...
  getResumenProyeccion(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
  ...
  getInformeCortes(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
  ...
  getResumenClientes(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
    ...
    return http
      .get(
        "get/informe_cortes_resumen_clientes",
        { params: params },
        { cancelToken: call.token }
      )
      .then((response) => {
  ...
  getBancosCuentasBancarias(callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
    ...
    call = CancelToken.source();
    return http
      .get("getBancosCuentasBancarias", { cancelToken: call.token })
      .then((response) => {
        return callback(response.data);
      })
      .catch((response) => {
