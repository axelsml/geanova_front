...
class lotesService {
  lotesByTerreno(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
  ...
  updatePerdonarInteres(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
    ...
    call = CancelToken.source();
    return http
      .post("updatePerdonarInteres", params, {
        cancelToken: call.token,
      })
      .then((response) => {
        return callback(response.data);
  ...
  agregarLotes(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
    ...
    call = CancelToken.source();
    return http
      .post("post/agregar_lotes", params, {
        cancelToken: call.token,
      })
      .then((response) => {
        return callback(response.data);
  ...
  eliminarLotes(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
    ...
    call = CancelToken.source();
    return http
      .delete("delete/eliminar_lotes", { params }, { cancelToken: call.token })
      .then((response) => {
        return callback(response.data);
      })
      .catch((response) => {
  ...
  getAllLotes(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
  ...
  postCoordenadas(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
    ...
    call = CancelToken.source();
    return http
      .post("post/coordenadas_lote", params, {
        cancelToken: call.token,
      })
      .then((response) => {
        return callback(response.data);
  ...
  postLoteCroquis(params, callback, error) {
    var call;
    if (call) {
      call.cancel();
    }
