 ...
 * @param {Función} props.callback: una función de devolución de llamada que se ejecutará después de crear el rol.
 * @param {Función} props.recargarDatos - Una función para recargar datos después de crear el rol.
 *
 * @returns {JSX.Element}: el elemento JSX para el nuevo componente de función.
 */
export default function NuevoRol({ callback, recargarDatos }) {
  // Variable de estado para el nombre del rol
  ...
  /**
   * Maneja el envío del formulario para crear un nuevo rol.
    ...
    await Swal.fire({
      ...
      if (result.isConfirmed) {
        configuracionService
          .guardarIRoles(onRolGuardado, form, onError)
          .then((result) => {
            onHandleCallback();
          });
      }
  ...
  /**
   * Función de devolución de llamada para manejar la respuesta después de crear un nuevo rol.
          ...
          <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Ingresa un nombre de Rol!",
                },
              ]}
            >
              <Input
